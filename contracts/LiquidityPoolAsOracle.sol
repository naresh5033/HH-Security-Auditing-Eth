...
contract LiquidityPoolAsOracle {
    ...
    //using this singular exchange for the swap price is a terrible idea
    //bcoz this is a sigle protocol for the single price, the price from the protocol is from the single centaralized location, and we don't want this.
