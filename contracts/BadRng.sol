...
contract BadRNG {
    ...
    function pickWinner() external {
        uint256 randomWinnerIndex = uint256(
            //this contact picks the rand winner based hash of  block.diificulty and the sender
            //this isn't truely random as the miners can influence the block difficulty and there are ton of vulnerabilities with creating rand in this way. 
